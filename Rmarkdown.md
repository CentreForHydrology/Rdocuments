...
- Also need LaTex installed if you use equations
...
- To create a presentation, use **File|New File**
...
.Rmd presentations
====================================================
- Can produce more sophisicated slides
- Requires LaTex
- Three different types of presentation:
  - beamer, slidy or ioslides
  - Can output to pdf (beamer), or html (slidy/ioslides)
- Use commmand **File|New File|R presentation**
- Separate slides with ## on first line
...
- A template was created by Reed College:
